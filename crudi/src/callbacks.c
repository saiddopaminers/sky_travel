...
f=fopen("/home/said/Projects/crudi/src/clieent.txt","a+");
	if(f!=NULL)
	{
...
f = fopen("/home/said/Projects/crudi/src/clieent.txt", "r");
...
f=fopen("/home/said/Projects/crudi/src/clieent.txt","r");
fich=fopen("/home/said/Projects/crudi/src/tempclieent.txt","w");
while(fscanf(f,"%s %s %s %s %s %s %s %s %s %s ",a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)!=EOF)
{
if(strcmp(k,a1)==0)
{
...
fclose(f);
fclose(fich);
remove("/home/said/Projects/crudi/src/clieent.txt");
rename("/home/said/Projects/crudi/src/tempclieent.txt","/home/said/Projects/crudi/src/clieent.txt");
FILE* fichier = NULL;

fichier = fopen("home/said/Projects/crudi/src/tempclieent.txt", "w");
if (fichier != NULL)
{
fputs("", fichier);
fclose(fichier);
